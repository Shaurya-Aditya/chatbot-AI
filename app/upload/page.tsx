  ...
  return (
    <div className="flex flex-col min-h-screen bg-background dark:bg-black">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 mt-16">
        <div
          className={`w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl p-10 flex flex-col items-center gap-8 border border-border dark:border-zinc-800 transition-all relative cursor-pointer ${dragActive ? 'ring-4 ring-primary/40 dark:ring-primary/60' : ''}`}
          ...
          tabIndex={0}
        >
          <h1 className="text-3xl font-extrabold mb-2 text-center text-foreground dark:text-white tracking-tight">Upload Document to Vector Store</h1>
